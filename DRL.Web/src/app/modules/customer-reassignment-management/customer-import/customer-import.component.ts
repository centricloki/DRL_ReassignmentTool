...
export class CustomerImportComponent implements OnInit, OnDestroy {
  ...
  /** True once account classifications have been fetched from the API */
   ...
   * Map key = AccountClassificationID (as string), value = AccountClassificationName.
   * Supports validation by both ID (e.g. "3") and Name (e.g. "C-Store").
   */
